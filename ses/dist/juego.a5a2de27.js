...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/dado.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/tablero.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Tablero, [{
    key: "setCasEspecial",
    value: function setCasEspecial(indice, cFinal) {
...
exports.default = _default;
},{}],"js/jugador.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Jugador, [{
    key: "setPosicion",
    value: function setPosicion(pos) {
      this.posicion = pos;
    }
  }, {
    key: "getPosicion",
    value: function getPosicion() {
      return this.posicion;
    }
  }, {
    key: "mover",
    value: function mover(dado) {
      this.posicion = dado;
    }
  }]);
...
var _dado = _interopRequireDefault(require("./dado.js"));

var _tablero = _interopRequireDefault(require("./tablero.js"));

var _jugador = _interopRequireDefault(require("./jugador.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

console.log('Testing');
var dado = new _dado.default();
var tablero = new _tablero.default();
var jugador1 = new _jugador.default();
var jugador2 = new _jugador.default(); //Escaleras
...
tablero.setCasEspecial(74 - 1, 92 - 1); //Serpientes
...
console.log("El jugador 1 est\xE1 en la casilla ".concat(jugador1.getPosicion() + 1));
console.log("El jugador 2 est\xE1 en la casilla ".concat(jugador2.getPosicion() + 1));
var test;

do {
  jugador1.mover(jugador1.getPosicion() + dado.lanzarDado());
  console.log("El jugador 1 se movi\xF3 a la casilla ".concat(jugador1.getPosicion() + 1, " con el dado en ").concat(dado.cara));
  test = jugador1.getPosicion();

  if (tablero.casilla[test] !== 0 && test <= 99) {
    jugador1.setPosicion(tablero.casilla[test]);
    console.log("Casilla especial, jugador 1 se mueve a ".concat(jugador1.posicion + 1));
  }

  jugador2.mover(jugador2.getPosicion() + dado.lanzarDado());
  console.log("El jugador 2 se movi\xF3 a la casilla ".concat(jugador2.getPosicion() + 1, " con el dado en ").concat(dado.cara));
  test = jugador2.getPosicion();

  if (tablero.casilla[test] !== 0 && test <= 99) {
    jugador2.setPosicion(tablero.casilla[test]);
    console.log("Casilla especial, jugador 2 se mueve a ".concat(jugador2.posicion + 1));
  }
...
},{"./dado.js":"js/dado.js","./tablero.js":"js/tablero.js","./jugador.js":"js/jugador.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
